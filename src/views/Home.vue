  ...
  <div class="container-fluid" v-if="SPINNER">
    <div class="row">
      ...
      <div class="col-lg-12 text-left">
        <h6 class="mb-3 text_color">Movies by categories</h6>
          ...
          >
            <table>
              <tr>
                ...
                <td style="padding: 5px" class="text_color">
                  {{genre.name }}
                </td>
              </tr>
            </table>
    ...
    <div class="row p-0">
    <h6 class="mb-5 ml-3 text_color align-left">Popular movies</h6>
...
<transition-group tag="div" class="row" name="movies" appear
@before-enter="before_enter"
@enter="enter">
      <div
        v-for="(movie, index) in POPULR_MOVIES.results" :data-index="index"
        :key="movie"
        
        class="col-md-2 col-6 mb-2 "
      >
        <div
          class="product-grid img-thumbnail p-0"
        ...
        >
          <div class="product-image" style="padding: 0px; border-radius: 10px">
            ...
            <span class="product-discount-label text_color" >{{
              movie.title
            }}</span>
          </div>

          <div class="product-content text-left">
            <small style="color: #abb2b9">
              ...
              <tr>
                <td>
                  ...
                  <router-link :to="{name:'Details',params:{id:movie.id}}" 
                    class="btn more_details btn-sm my-2 my-sm-0 button_bg"
                    type="submit"
...
export default {
  ...
  setup() {
    ...
    fetch("https://api.themoviedb.org/3/genre/tv/list?api_key=7e0768276e28e7e3f4136f2e524c7c7c&language=en-US")
