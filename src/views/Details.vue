  ...
  <div class="container-fluid">
    <transition-group name="bg" appear>
      <div
        ...
        v-bind:style="{
          'background-image':
            'linear-gradient(to top,black 20%,#F99205 100%),url(' +
            IMG_URL +
          ...
          <div class="row">
            <div class="col-lg-3">
              <div
                ...
                v-bind:style="{
                  'background-image':
                    'url(' + IMG_URL + MOVIE_DETAILS.poster_path + ')',
                }"
              />
            </div>
            <div class="col-lg-9">
              <table class="m-3">
                <tr>
                  <h2 class="text_color">
                    {{
                      MOVIE_DETAILS.genres && MOVIE_DETAILS.genres.length > 0
                ...
                <tr>
                  <td class="title">
                    <img src="../assets/images/stars.png" class="rating_big" />
                ...
                <tr>
                  <td classs="text_color">
                    <img
                      src="https://i.pinimg.com/originals/19/7b/36/197b365922d1ea3aa1a932ff9bbda4a6.png"
                      class="youtube"
                    /><small class="text_color">Trailer:</small>
                  </td>
                </tr>
                <tr>
                  <td>
                    ...
                    <a
                      :href="IMG_URL + MOVIE_DETAILS.poster_path"
                      class="btn-sm my-2 my-sm-0 button_icon"
                      type="submit"
                      ><i class="fa fa-eye"></i
                    ></a>
                    <button
      ...
      {
        {
          ...
          fetch(
            "https://api.themoviedb.org/3/movie/" +
              props.id +
              "?api_key=7e0768276e28e7e3f4136f2e524c7c7c"
          )
            .then((res) => res.json())
...
.movies_details {
  height: 500px;
  width: 95%;
  background-image: linear-gradient(to top, black 20%, #f99205 100%),
    url("https://i.pinimg.com/originals/20/b4/18/20b418c579302b5b0530a637a44bf3cf.jpg");
